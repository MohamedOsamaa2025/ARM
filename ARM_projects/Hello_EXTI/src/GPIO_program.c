...
void MGPIO_voidSetPullUpDownResistor(u8 Copy_u8PortName, u8 Copy_u8PinNumber, u8 Copy_u8PullUpDownState)
{
	...
	{
		case GPIO_PORTA:
			GPIOA_PUPDR &= ~(PUPDR_MASK << (Copy_u8PinNumber * PIN_OFFSET));
			GPIOA_PUPDR |= (Copy_u8PullUpDownState << ((Copy_u8PinNumber * PIN_OFFSET)));
		break;
		
		case GPIO_PORTB:
			GPIOB_PUPDR &= ~(PUPDR_MASK << (Copy_u8PinNumber * PIN_OFFSET));
			GPIOB_PUPDR |= (Copy_u8PullUpDownState << ((Copy_u8PinNumber * PIN_OFFSET)));
		break;
...
u8 MGPIO_u8GetPinValue(u8 Copy_u8PortName, u8 Copy_u8PinNumber)
{
	...
	{
		case GPIO_PORTA:
			Local_u8PinValue = GET_BIT(GPIOA_IDR, Copy_u8PinNumber);
		break;
